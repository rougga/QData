<%@page import="ma.rougga.qdata.modal.report.ThTTRow"%>
<%@page import="ma.rougga.qdata.controller.report.ThTTTableController"%>
...
<%
    ...
    List<Map> table = new ThTTTableController().getTableAsList(date1, date2, agences);
    ThTTRow totaleRow = new ThTTRow();
%>
<!DOCTYPE html>
<html>
    <head>
                            ...
                            <tbody  class="font-weight-bold ">
                                ...
                                <%
                                    ...
                                    if (empsObj instanceof List<?>) {
                                        List<ThTTRow> emps = (ArrayList<ThTTRow>) empsObj;
                                        totaleRow = emps.get(emps.size() - 1);
                                        for (ThTTRow emp : emps) {
                                %>
