<%@page import="ma.rougga.qdata.modal.report.ThSARow"%>
<%@page import="ma.rougga.qdata.controller.report.ThSATableController"%>
...
<%
    ...
    List<Map> table = new ThSATableController().getTableAsList(date1, date2, agences);
    ThSARow totaleRow = new ThSARow();
%>
<!DOCTYPE html>
<html>
    <head>
                            ...
                            <tbody  class="font-weight-bold ">
                                ...
                                <%
                                    ...
                                    if (empsObj instanceof List<?>) {
                                        List<ThSARow> emps = (ArrayList<ThSARow>) empsObj;
                                        totaleRow = emps.get(emps.size() - 1);
                                        for (ThSARow emp : emps) {
                                %>
