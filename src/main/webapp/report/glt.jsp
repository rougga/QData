<%@page import="ma.rougga.qdata.controller.report.GltTableController"%>
<%@page import="ma.rougga.qdata.modal.report.GltRow"%>
...
<%
    ...
    List<Map> table = new GltTableController().getTableAsList(date1, date2, agences);
    GltRow totaleRow = new GltRow();
%>
<!DOCTYPE html>
<html>
    <head>
                            ...
                            <tbody  class="font-weight-bold ">
                                ...
                                <%
                                    ...
                                    if (empsObj instanceof List<?>) {
                                        List<GltRow> emps = (ArrayList<GltRow>) empsObj;
