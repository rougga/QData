<%@page import="ma.rougga.qdata.modal.report.ThARow"%>
<%@page import="ma.rougga.qdata.controller.report.ThATableController"%>
...
<%
    ...
    List<Map> table = new ThATableController().getTableAsList(date1, date2, agences);
    ThARow totaleRow = new ThARow();
%>
<!DOCTYPE html>
<html>
    <head>
                            ...
                            <tbody  class="font-weight-bold ">
                                ...
                                <%
                                    ...
                                    if (empsObj instanceof List<?>) {
                                        List<ThARow> emps = (ArrayList<ThARow>) empsObj;
